...
class SftpWidget(Gtk.Box):
    ...
    def _create_local_panel(self):
        ...
        self.local_store = Gtk.ListStore(str, str, str, GObject.TYPE_INT64, str, int, str, GObject.TYPE_INT64, bool, str) # Using GObject types explicitly
    ...
    def _create_remote_panel(self):
        ...
        self.remote_store = Gtk.ListStore(str, str, str, GObject.TYPE_INT64, str, int, str, GObject.TYPE_INT64, bool, str) # Using GObject types explicitly
