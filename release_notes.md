...
* **Fixed focus not returning to the terminal after using the Run button in Quickies** — you had to click back into the terminal by hand to keep typing; Run (and Send, and double-click, and the right-click menu) all hand focus back to the terminal now.
